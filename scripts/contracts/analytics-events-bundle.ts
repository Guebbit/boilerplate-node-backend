...
/**
 * The order the groups appear in — auth and the account record first, then the path a user walks
 * through the shop, and the client's own moments last.
 *
...
const SECTIONS = [
    ...
    {
        module: 'users',
        constant: 'usersAnalyticsEvents',
        events: usersAnalyticsEvents,
        scope: 'backend'
    },
    {
        module: 'products',
...
const HEADER = `// Code generated by the paired backend's \`contracts:bundle\`. DO NOT EDIT.
/**
