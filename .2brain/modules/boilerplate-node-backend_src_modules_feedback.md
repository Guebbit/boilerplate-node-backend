...
2. **`service.ts`** — it contains the core business rules (anti-bot checks, status transitions, pagination, hard delete) without HTTP or Mongoose noise, making it the clearest place to understand *what* the module actually does.
