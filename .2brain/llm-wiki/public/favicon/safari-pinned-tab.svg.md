...
- Because it uses potrace's Y-flip transform, the path coordinates appear "upside-down" if you open them in a raw path editor. The visual top of the icon is at the *bottom* of the coordinate space.
