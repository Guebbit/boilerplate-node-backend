...
- This test is intentionally cross-cutting: it doesn't test one module in isolation but the _consistency_ between the registry output and the live Mongoose schema.
