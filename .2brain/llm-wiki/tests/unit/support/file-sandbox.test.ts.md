...
- **`describe('emptyFileSandbox')`** – writes files into all five sub-directories, calls the function, and verifies they are gone; also verifies it *refuses* to delete a file whose env-var path escapes the sandbox root.
