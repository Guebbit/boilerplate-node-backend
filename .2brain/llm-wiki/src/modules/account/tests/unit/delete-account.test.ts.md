...
- **`@modules/account/services/index.ts`** — `accountService` is fully mocked; the test asserts _which_ service methods the controller invokes and in what order, not their internal behavior.
