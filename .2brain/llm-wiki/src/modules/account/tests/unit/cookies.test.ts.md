...
- **`describe('destroyRefreshCookie')`** (2 tests) – asserts `clearCookie` is called with the *same* flag triple the create path used, including the env-dependent `secure` flag.
