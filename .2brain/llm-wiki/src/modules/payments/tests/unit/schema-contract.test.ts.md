...
- Tests assert against extracted schema metadata (via the shared helpers) rather than instantiating documents, so they verify _declaration_ not _runtime behaviour_.
