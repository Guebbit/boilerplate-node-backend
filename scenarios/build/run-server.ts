...
MongoMemoryServer.create()
    .then((mongod) => {
        ...
        // The positive proof S1 relies on: this is the only call site in the whole codebase, so
        // no copied `.env` can mount the control surface on a host that isn't this one.
        enableDemoProfile();
