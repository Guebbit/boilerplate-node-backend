/**
 * `src/core/adapters/logger.ts` — redaction and error serialization.
 *
...
const loadLoggers = async () => {
    jest.resetModules();
    return (await import('@core/adapters/logger')) as typeof import('@core/adapters/logger');
};
