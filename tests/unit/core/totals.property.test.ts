/**
 * Property-based tests — `src/core/totals.ts`.
 *
...
import { sumLineItems, toCents, type ILineItem } from '@core/totals';
 ...
 */
// eslint-disable-next-line unicorn/no-null, unicorn/no-useless-undefined -- see above
