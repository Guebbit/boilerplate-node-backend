/**
 * `attachLocale` — `src/middlewares/locale.ts`.
 *
 ...
 *     imports `t` from `@core/i18n` gets the request's language only because it executes within
...
import { getCurrentLocale, getLocaleContext, listSupportedLocales } from '@core/i18n';
