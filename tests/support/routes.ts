 ...
 * silently, and in the direction of MORE access. Dropping `requirePermission` from a delete route, writing
 ...
 *
 * `isAuth`/`requirePermission`/`getAuth` pass through unchanged from the actual module — they are declared
