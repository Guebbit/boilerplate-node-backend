...
| 6   | [Seed a shop the app could make](SCENARIOS_NEXT_6_SEEDED_DATA.md)      | D7 — the paired frontend's two stale specs              | D1–D6 built and deleted from the file, 2026-09-12; D7 (frontend) is all that's left                                 |
...
flowchart LR
    ...
    F5 --> F6["6 · seeded data — D1-D6 done, D7 left"]
...
- **6 is done except D7**, which is the paired frontend's own two stale specs.
