...
Generated by `npm run scenario:images` (`scenarios/tools/generate-seed-images.ts`) — a real photo per
...
enumerate which files are seed images, and adding one does not mean editing `.gitignore`.
