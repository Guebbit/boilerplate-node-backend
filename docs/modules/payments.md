...
| `providers/card.ts`                   | The provider port and the implementation behind it, so nothing above the port knows which processor is wired in.                                             | [read](../theory/layers.md)              |
