...
|                 | Reaches                                                                            | Reached by                                                                         |
| --------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `account`       | addresses, audit-logs, cart, delivery, feedback, orders, payments, users, wishlist | —                                                                                  |
| `cart`          | addresses, delivery, inventory, orders, payments, products, users                  | account, wishlist                                                                  |
