...
are real, but none of them is a directory. The repo is divided first by **domain**: a module
folder per domain, each containing all of these blocks top to bottom, and `src/controllers`, `src/services` <!-- doc-paths:ignore -->
