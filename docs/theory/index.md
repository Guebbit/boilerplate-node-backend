...
It is about patterns, not product details.
...
- **Fail-open optional infrastructure**: Redis, Loki, and PostHog improve behavior when configured, but the app keeps running when they are disabled.
