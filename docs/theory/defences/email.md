...
| Attack                       | How it works                                   | This boilerplate                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Email bombing / resend abuse | unlimited resend endpoints                     | Two mechanisms, because they answer different things. `credentialLimiters` on `/reset`, `/verify-request` and the 2FA send route bound the attempts, and `mfaSendLimiter` bounds outbound CODES separately from guesses, since sending and guessing are different budgets — `account/rate-limits.ts`. But those limiters carry `skipSuccessfulRequests`: only a FAILURE spends the budget, which is right for a login guess and wrong for a button whose success publishes the mail. So each re-send also holds a per-account cooldown, returned as `resendAfter` so a client counts down rather than inventing its own — `account/services/verification.ts`, `account/services/two-factor.ts` |
