...
| Attack                 | How it works                                                                    | This boilerplate                                                                                                                                                                                                                                                                             |
| ---------------------- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloud metadata access  | credentials from `169.254.169.254` in a cloud VM without IMDSv2                 | Reachable only through an SSRF primitive, and there is none. The deployment-side control — blocking link-local egress — is the host's, not this repo's.                                                                                                                                      |
