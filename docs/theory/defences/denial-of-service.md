...
| Attack                        | How it works                                         | This boilerplate                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ----------------------------- | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Email / SMS bombing           | unlimited resend endpoints; SMS pumping (toll fraud) | `credentialLimiters` on `/reset`, `/verify-request` and the 2FA send route; `mfaSendLimiter` bounds outbound codes separately from guesses — `rate-limit.ts`. A limiter alone is not enough where a SUCCESS is the expensive call, since `skipSuccessfulRequests` means only failures spend the budget — so the two re-send endpoints carry their own cooldown; see [Email](email.md#how-much-mail). SMS pumping has no surface: there is no SMS factor. |
