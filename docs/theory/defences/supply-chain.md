...
| Base-image vulnerabilities      | outdated OS packages in the image              | Pinned to `node:24-alpine` by major only, so a rebuild picks up patches — and only a rebuild does.                                                                                                                                                                             |
