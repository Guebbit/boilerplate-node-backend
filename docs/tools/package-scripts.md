...
| `gen:migrations`         | generate | assemble `db/migrations/` — the index baseline read off each module's schema, plus every module's own migrations         | [Data](../reference/data.md)                               |
