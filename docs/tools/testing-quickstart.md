...
see [Docker & Podman](./docker-and-podman.md#running-the-gate-in-a-container).
...
- [Docker & Podman](./docker-and-podman.md#running-the-gate-in-a-container) — running this whole gate inside the image
