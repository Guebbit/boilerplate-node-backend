...
function refWithControl(initial, options = {}) {
    ...
    function set2(value, triggering = true) {
        ...
        const old = source;
        if (
            ((_a = options.onBeforeChange) == null ? void 0 : _a.call(options, value, old)) ===
            false
        )
            return;
        source = value;
...
function formatDate(date, formatStr, options = {}) {
    ...
    return formatStr.replace(REGEX_FORMAT, (match, $1) => {
        var _a2, _b;
        return (_b =
            $1 != null ? $1 : (_a2 = matches[match]) == null ? void 0 : _a2.call(matches)) != null
            ? _b
            : match;
    });
}
...
function useDropZone(target, options = {}) {
    ...
    if (isClient) {
        ...
        const handleDragEvent = (event, eventType) => {
            ...
            isValid =
                (_b2 = dataTransferItemList && checkValidity(dataTransferItemList)) != null
                    ? _b2
                    : false;
...
function tracksToArray(tracks) {
    return Array.from(tracks).map(
        (
            { label, kind, language, mode, activeCues, cues, inBandMetadataTrackDispatchType },
            id
        ) => ({
            id,
            label,
