...
| `tests/integration/concurrency/payment-races.test.ts`  | Money and stock under simultaneous callers: a double confirm, a redelivered webhook, overselling the last units, a cancel racing the payment.                                                                    | [Concurrency Testing](../tools/concurrency-testing.md) |
