...
| `tests/cross-cutting/authenticated-controllers.test.ts`     | A controller asserting the caller with `request.authContext!` is mounted behind `isAuth` — the half no type can carry, including the mid-file `router.use` hazard.                                                                              | [Request Flow](../theory/request-flow.md)                                                                                  |
...
| `src/modules/*/tests/fixtures.ts`           | Test-only fixture builders too specific to belong in the module's published fixture builder.                                                                                                                                                                                                                   | [Unit Testing](../tools/unit-testing.md)                                                    |
