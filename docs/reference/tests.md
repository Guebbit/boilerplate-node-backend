...
`tests/cross-cutting/module-test-boundaries.test.ts` enforces the line.
...
| `tests/cross-cutting/module-test-boundaries.test.ts`   | A co-located spec stays inside its module's boundary, so a module's tests do not quietly couple it to a sibling.                                                                                                                                | [Unit Testing](../tools/unit-testing.md)                                                                                   |
...
| `tests/cross-cutting/every-controller-catches.test.ts` | A controller that starts a promise chain ends it with a catch.                                                                                                                                                                                  | [Request Flow](../theory/request-flow.md)                                                                                  |
| `tests/cross-cutting/no-hardcoded-user-text.test.ts`   | The error list never carries a user-facing string literal — copy comes from a dictionary.                                                                                                                                                       | [Scripts & Hooks](./scripts.md)                                                                                            |
...
| `tests/cross-cutting/demo-boundary.test.ts`            | Demo data stays out of the runtime import graph — the production build cannot reach a fixture.                                                                                                                                                  | [Demo profile](../tools/demo-profile.md)                                                                                   |
...
| File                                                    | What it guarantees                                                                                                                                                          | Read next                                                |
| ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `tests/unit/api-codegen.test.ts`                        | The generated API types import without a runtime error — the canary for a broken generation run.                                                                            | [Regenerating After a Change](../api/regenerating.md)    |
...
| `tests/unit/infrastructure/i18n.test.ts`                | Locale negotiation: what a request gets from its headers, a stored preference, and the fallback.                                                                            | [Request Flow](../theory/request-flow.md)                |
...
| File                                                               | What it guarantees                                                                                                       | Read next                                                |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| `tests/unit/infrastructure/adapters/cache.test.ts`                 | TTL resolution and the fail-open behaviour the whole cache depends on.                                                   | [Redis Cache](../tools/redis-cache.md)                   |
...
| `tests/unit/infrastructure/adapters/workers.test.ts`               | The two consumers: queue names, ack on success, dead-letter on permanent failure.                                        | [RabbitMQ](../tools/rabbitmq.md)                         |
...
| `tests/unit/infrastructure/http/middlewares/cache.test.ts`          | The cache key depends on the query parameters the answer actually depends on.                          | [Redis Cache](../tools/redis-cache.md)                             |
