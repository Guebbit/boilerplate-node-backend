...
| `docker-compose.production.yml` | The production shape of the same stack — the built image instead of a bind mount, no dev tooling.                                                                                       | [Docker & Podman](../tools/docker-and-podman.md)                                                    |
