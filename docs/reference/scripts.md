...
| `scripts/contracts/fragments.ts`            | What a bundle IS — the two kinds, compiled from authored sources or generated from a committed document, and the staleness comparison every one of them answers. Builds nothing itself. | [Contract Ownership & Fragmentation](../api/contract-fragmentation.md) |
