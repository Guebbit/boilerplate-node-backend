...
| 2   | [Bank transfer at checkout](OFFLINE_PAYMENTS_2_BANK_TRANSFER.md) | customer picks transfer; the order waits days, not 30 min | the awaiting-transfer rows of 3    | done, backend + frontend |
