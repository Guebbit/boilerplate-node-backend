/**
 * @module
 * Requests the contract cannot describe, for the account module — `scripts/contracts/client-collections-bundle.ts`
 * owns the rest: what a probe is for, where these are emitted, and which `{{seedToken}}` values a
 * probe may refer to.
 */
