 ...
 * dataset through it, and `scenarios/build/export-dataset.ts` publishes the result as
 * `scenarios/dataset.json`, so a defect here reaches the whole demo catalogue. The rule it holds:
