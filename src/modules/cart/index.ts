 ...
 *
 * `cartRepository` is deliberately absent, and that is a decision rather than an oversight:
 * publishing a repository hands every sibling a write on this collection with the service — and the
 * rules it carries — bypassed, and no production caller ever wanted one. The
