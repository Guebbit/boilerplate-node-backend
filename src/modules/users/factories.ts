 ...
 * a person. States no schema default — `imageUrl`, `locale`, `role`, `active`, `verified` and
 ...
 * `User` rather than restated, since the contract already declares `role`, `active`, `verified`
