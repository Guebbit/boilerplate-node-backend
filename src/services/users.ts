 ...
 * Cart and auth logic live in their own focused services (SRP/ISP).
 */
...
/**
 * User Admin Service aggregate export.
 * Only contains admin CRUD operations — cart and auth are separate services.
 */
